...
import time
import np
img00=cv2.imread('red.jpg')
img1 = cv2.resize(img00,(250,250))
background01=cv2.imread('red.jpg')
...
img01=cv2.imread('green.jpg')
img2 = cv2.resize(img01,(250,250))
background02=cv2.imread('green.jpg')
...
img02=cv2.imread('blue.jpg')
img3 = cv2.resize(img02,(250,250))
background03=cv2.imread('blue.jpg')
...
img03=cv2.imread('yellow.jpg')
img4 = cv2.resize(img03,(250,250))
background04=cv2.imread('yellow.jpg')
